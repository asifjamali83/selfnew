...
tagadd = {
    ...
    "tags": False,
    "tag": "You missing me😜",
    "add": "Lover is Always here",
    "wctext": "Welcome to My Famz",
    "lv": "Miss you dear",
    "b": "I think you have been Blocked🤗",
    "m": "😎",
}
apalo = {
    "blacklist":{},
...
def sendMentionFooter(to, mid, firstmessage, lastmessage):
    try:
        ...
        ticket = "https://line.me/ti/p/~shahzain83"
        ...
        if op.type == 15:
          if settings["Leave"] == True:
           ...
           "contents": [
                              ...
                              "uri": "https://line.me/ti/p/~shahzain83"
                          }
                     },
                ]
           },
  ...
  "contents": [
              ...
              "contents": [
                ...
                if text.lower() == "panduan/bc":
                    ...
                    sa+="\n-Contoh> <"
                    sa+="\n-bc/aboutme.."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "༺༽།ŚhÀH•ŹÀ!η༼༻", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == "stag":
                    ...
                    sa += "\nContoh"
                    sa += "\nstag 1 @user"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "༺༽།ŚhÀH•ŹÀ!η༼༻", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u266f0d1211f905b2ca386024d9d4e165"}}
                    sendTemplate(to,data)
                                        ...
                                        "contents": [
                                            {
                                                ...
                                                "contents": [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "action": {
                                                            "type": "uri",
                                                            "uri": "http://line.me/ti/p/~shahzain83"
                                                        }
                                                    },
                                                    {
                                                        "type": "spacer",
...
#=========================================================
                if text.lower() == ".autolike on":
                    ...
                    data = {"type": "text","text": "{}".format(am),"sentBy": {"label": "༺༽།ŚhÀH•ŹÀ!η༼༻", "iconUrl": "https://obs.line-scdn.net/{}".format(achink.getContact(achinkMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u6e4534dd63e82642f29205d2c993c642"}}
                    sendTemplate(to,data)
                ...
                for sticker in stickers2:
                    try:
                        if text.lower() == sticker:
                            ...
                            if a.hasAnimation == True:data = {"type": "template","altText": "{} sent a sticker.".format(achink.getProfile().displayName),"template": {"type": "image_carousel","columns": [{"imageUrl": "https://stickershop.line-scdn.net/stickershop/v1/sticker/{}/IOS/sticker_animation@2x.png".format(sid),"size": "full","action": {"type": "uri","uri": "http://line.me/ti/p/~shahzain83"}}]}}
